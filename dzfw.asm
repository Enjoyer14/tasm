...
task1 macro matrix, row, col, max, tab
...
mPrintLine macro matrix, row, col, row_to_print, tab, endl
local colLoop
	push ax
	push bx
	push cx
...
task2 macro matrix, row, col, max, min, minId, maxId, tab, endl, temp, line, line2
...
task3 macro matrix, row, col, sortedLine, lineId, tempLine, tab, endl, min
